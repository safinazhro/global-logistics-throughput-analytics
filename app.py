...
# 1. Konfigurasi Tampilan Halaman Utama (Tema Bersih Standar)
st.set_page_config(
...
with col_left:
    ...
    st.bar_chart(cargo_perf)
    
    st.info("Insight Analis: Kargo jenis Hazardous memiliki tingkat efisiensi terendah karena protokol regulasi yang ketat. Penambahan alat bantu mekanis direkomendasikan untuk menaikkan rasio m³/jam-orang.")
...
with col_right:
    ...
    st.line_chart(labor_bottleneck)
    
    st.warning("Deteksi Bottleneck: Penugasan hanya 2-3 pekerja per kontainer membuat durasi pembongkaran melonjak tajam melewati batas aman 2 jam. Alokasi optimal berada pada titik minimal 4 staf per unit kargo.")
